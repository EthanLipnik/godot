#ifndef GODOT_PATH_TRACING_M0_CANONICAL_SCENE_PACKET_H
#define GODOT_PATH_TRACING_M0_CANONICAL_SCENE_PACKET_H

#include <cstddef>
#include <cstdint>

namespace GodotPathTracingM0 {
...
#endif // GODOT_PATH_TRACING_M0_CANONICAL_SCENE_PACKET_H
